import {CollectionTemplateModel, CustomCollectionModel, PatientModel,} from "@/server/models";
import {createTRPCRouter, protectedProcedure,} from "@/server/api/trpc";
import {z} from "zod";
import {TRPCError} from "@trpc/server";
import {patientProfileSchema, type PatientProfileType,} from "@/validation/patient";

import {numeric} from "@/validation/utils";
import {type PatientAddress, type PatientDocument, type PatientRelativePhoneNumbers,} from "@/types/mongo";

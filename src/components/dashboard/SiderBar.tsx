...
const pageLinksImages: { [k: string]: React.ReactNode } = {
  ...
  "dashboard/patients": (
    <CiMedicalCase className="h-[25px] w-[25px] shrink-0" />
  ),
  "dashboard/collections": (
    <CiFolderOn className="h-[25px] w-[25px] shrink-0" />
  ),
  "dashboard/organizations": (
    <CiHospital1 className="h-[25px] w-[25px] shrink-0" />
  ),
  "dashboard/roles": <CiGrid41 className="h-[25px] w-[25px] shrink-0" />,
  "dashboard/settings": <CiSettings className="h-[25px] w-[25px] shrink-0" />,
  "dashboard/users": <CiUser className="h-[25px] w-[25px] shrink-0" />,
};
